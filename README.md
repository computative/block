This is the github-repository for a 'blocking method' for estimation of expected values with errors for very large time series. The code does this by working in O(n)-time. There are implementations for:
- Python
- R
- C++
- Armadillo
