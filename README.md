This is the girhub-repository for a new tool for estimation of expected values and their errors for very large time series. The code does this by working in O(n)-time. There are implementations for:
- Python
- R
- C++
- Armadillo C++
